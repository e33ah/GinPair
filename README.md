...
2. Configure the database connection string - update the connection string in appsettings.json with your PostgreSQL database

3. Apply ef migrations - to create the database schema and apply existing migrations run: `dotnet ef database update`
